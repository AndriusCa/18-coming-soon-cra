    ...
    <footer className="container bg-main">
      <div className="row">
        <div className="socials">
          ...
          <a className="fa fa-rss" href="/">
            RSS
          </a>
        </div>
        <a className="btn btn-circle fa fa-angle-up" href="/">
          Back to top
        </a>
      </div>
      <div className="row-short">
        ...
        <div className="text-trio">
          <p>
            Copyright &copy; 2023 <a href="/">Matrox</a>
          </p>
        ...
        <p>
          ...
          facere dolor accusantium vero modi <a href="/">Matrox</a> nihil nisi
          aperiam. Doloremque nihil nisi ducimus sunt ratione temporibus
          possimus, minima <a href="/">Matrox</a> laudantium.
        </p>
      </div>
    </footer>
  )
